        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title">&nbsp;&nbsp;<span>Inward-Outward<br>by EIBO</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="inward.php"><i class="fa fa-bank"></i> Inward</a>
                  </li>
                  <li><a href="outward.php"><i class="fa fa-bank"></i> Outward</a>
                  </li>
                  </li>
                  <li><a><i class="fa fa-sitemap"></i>Payment<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="./level1.php">Cash</a></li>
                      <li><a href="./network_list.php">Online</a></li>
                      <li><a href="./automatrix_list.php">Check</a></li>
              ...
              <!--      </ul>-->
              <!--    </li>-->
              <!--    <li><a><i class="fa fa-plane"></i>Tour <span class="fa fa-chevron-down"></span></a>-->
              <!--      <ul class="nav child_menu">-->
              <!--        <li><a href="national_tour.php">National </a></li>-->
              ...
              <!--      <ul class="nav child_menu">-->
              <!--        <li><a href="yem_wallet_ledger.php">YEM Wallet</a></li>-->
